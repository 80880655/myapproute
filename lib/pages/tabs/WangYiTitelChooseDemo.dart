...
class WangYiTitelChooseDemo extends StatefulWidget {
  @override
  _WangYiTitelChooseDemoState createState() => _WangYiTitelChooseDemoState();
}

class _WangYiTitelChooseDemoState extends State<WangYiTitelChooseDemo> {
  var mList = [
    '要闻',
    '推荐',
    '关注流',
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(title: Text('仿网易标签选择器显 Dragable GridView Page')),
    ...
    if (isRec)
      ...
      return GestureDetector(
          ...
          onTap: () {
            ...
            // “完成”就是可以开始编辑--- true； 显示“编辑”代表已经完成--false；
            print("点击的编辑和完成：" + isEdit.toString());
            if (isEdit) {
              // 写入当前存储的对象数据。
              print("1212121");
            }
        ...
        child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              return GestureDetector(
                  ...
                  onTap: () {
                    // 2020/11/12 11:30 分，点击某一个标签
                    print("2222");
                    print("你点击的是:" + list[index] + ";" + index.toString());
        ...
        child: Container(
            ...
            child: Padding(
                ...
                child: Center(
                  ...
                  // gaofeng 2020/11/26 14:40 小标签增加 X 和 + 的图标
                  (isEdit && list == mList)
